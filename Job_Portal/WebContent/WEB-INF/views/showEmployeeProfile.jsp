...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
 			...
 			messages[16] = "Please enter Primary Skills!!!";
 			messages[17] = "Please select Years of experience!!!";
			...
			function doRegister() {				
				if( !validateEmail($('#employeeEmail').val())){
					...
					viewMessage(15);
					$('#employeePrimarySkills').focus();
				}else if( $('#employeeYearExp').val() == "0" ) {
					viewMessage(16);
					$('#employeeYearExp').focus();
 			...
 			function doPopulateStateOnLoad() { 	
 	 			resetCity();			
 	 			$.ajax({
 		            url : 'getStateList',
 		           data : "countryId=${employee.country.countryId}&stateId=${employee.state.stateId}",
 			...
 			function doPopulateCityOnLoad() { 	 						
 				$.ajax({
 		            url : 'getCityList',
 		           data : "stateId=${employee.state.stateId}&cityId=${employee.city.cityId}",
 		            success : function(data) { 		            	
 			...
 			doPopulateStateOnLoad();
 			doPopulateCityOnLoad();
	...
	<div class="content-warp">
		<div class="container">
			...
			<table width="100%" cellspacing="0" cellpading="0">
				<tr height="30">
					<td class="heading-top"><h1>My Profile</h1></td>
					<td>
  			...
  			<div class="registration-box">
  				<br/>  							
  				<form:form method="POST" action="updateEmployee" commandName="employee" name="employee" >
	    			<div class="row" align="center">	          			
	            		<label><i><img src="<c:url value="/resources/images/star.gif" />" /></i>Email ID</label>
	            		<form:input path="employeeEmail" cssClass="input-text" readonly="true"/>
	            		<label><i><img src="<c:url value="/resources/images/star.gif" />" /></i>Password</label>
	            		<form:password path="employeePassword" cssClass="input-text"  showPassword="true" />          			
	        		</div>        		
	    			<div class="row" align="center">	          			
	        		...
	        		<div class="row" align="center">	          			       				
	            		...
	            		<form:input path="employeeMobile" cssClass="input-text" readonly="true"/>         			
	        		</div>
	        		<div class="row" align="center">
	        			<input type="button" class="red-btn" value="Save Profile" onClick="javascript:doRegister();"/>
	        		</div>
	...
	<c:if test="${not empty update_profile}">
		<script type="text/javascript">
			viewMessage(15);
		</script>	
	</c:if>
