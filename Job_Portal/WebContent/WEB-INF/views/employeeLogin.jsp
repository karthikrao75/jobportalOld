			...
			<div class="main_page">
				<section class="block-left">
					<div class="seeker_login">
						...
						<form:form method="POST" action="/Job_Portal/showEmployeeProfile" commandName="employeeLogin" name="employeeLogin" >
							<div>
								<div class="label">
						...
						<div>
							<p><a href="multiboxRedirector.jsp?fun=employee_forgot_pwd" id="mb9" class="mb" rel="width:700,height:300">Forgot Password?</a></p>
						</div>
						<div class="clear"></div>
					</div>
