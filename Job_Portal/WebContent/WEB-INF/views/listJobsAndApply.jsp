...
<head>
	...
	<script type="text/javascript">
		...
		function doApplyJob(employerJobId){
			document.applyJob.employerJobId.value = employerJobId;
	...
	<div class="container">
		...
		<div class="registration-box">
			...
			<table border="0" cellpadding="5" cellspacing="5" align="center" width="800">
				<tr>
					<td width="175" class="top-resumes"><h3><b>Job Title</b></h3></td>
					<td width="175" class="top-resumes"><h3><b>Job Location</b></h3></td>
					<td width="175" class="top-resumes"><h3><b>Role</b></h3></td>
					<td width="175" class="top-resumes"><h3><b>Experience</b></h3></td>
					<td width="175" class="top-resumes"><h3><b>Company Name</b></h3></td>	
					<td width="125" class="top-resumes"><h3><b>Salary</b></h3></td>		
					<td width="125" class="top-resumes"><h3><b>Apply</b></h3></td>					
				</tr>	
				<c:forEach var="employerJob" items="${jobsList}">
					<tr>
						...
						<td width="125" class="top-resumes">
							<input type="button" class="red-btn" value="Apply" onClick="javascript:doApplyJob('${employerJob.employerJobId}');"/>
						</td>						
					</tr>
				</c:forEach>			
			</table><br><br/>
...
<form name="applyJob" action="/Job_Portal/applyJob" method="post">
