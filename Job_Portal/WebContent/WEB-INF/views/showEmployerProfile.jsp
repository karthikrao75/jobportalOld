...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
 			...
 			messages[16] = "Please enter company name!!!";	 			
			...
			function doRegister() {				
 			...
 			function doPopulateStateOnLoad() { 	
 	 			...
 	 			$.ajax({
 		            url : 'getStateList',
 		           data : "countryId=${employer.country.countryId}&stateId=${employer.state.stateId}",
 			...
 			function doPopulateCityOnLoad() { 	 						
 				$.ajax({
 		            url : 'getCityList',
 		           data : "stateId=${employer.state.stateId}&cityId=${employer.city.cityId}",
 		            success : function(data) { 		            	
		...
		<div class="container">
			...
			<table width="100%" cellspacing="0" cellpading="0">
  			...
  			<div class="registration-box" style="height:690px;">
  				<br/>  							
  				<form:form method="POST" action="updateEmployer" commandName="employer" name="employer" >
	    			<div class="row" align="center">	          			
	            		<label><i><img src="<c:url value="/resources/images/star.gif" />" /></i>Email ID</label>
	            		<form:input path="employerEmail" cssClass="input-text" readonly="true"/>
	...
	<c:if test="${not empty update_employer_profile}">
		<script type="text/javascript">
			viewMessage(15);
		</script>	
	</c:if>
